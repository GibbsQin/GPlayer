...
/* package */ final class AudioTimestampPoller {
  ...
  public long getTimestampSystemTimeUs() {
    return audioTimestamp != null ? audioTimestamp.getTimestampSystemTimeUs() : (Long.MIN_VALUE + 1);
  }
  ...
  public long getTimestampPositionFrames() {
    return audioTimestamp != null ? audioTimestamp.getTimestampPositionFrames() : -1;
  }
