...
void JniHelper::callVoidMethod(jobject obj, jmethodID methodId, jint arg1) {
    if (sJavaVM == nullptr) {
        LOGE(TAG, "sJavaVM is nullptr");
        return;
    }
    ...
    if (env != nullptr) {
        env->CallVoidMethod(obj, methodId, arg1);
    }
...
void JniHelper::callVoidMethod(jobject obj, jmethodID methodId, jint arg1, jstring arg2) {
    if (sJavaVM == nullptr) {
        LOGE(TAG, "sJavaVM is nullptr");
        return;
    }
...
void JniHelper::callVoidMethod(jobject obj, jmethodID methodId, jstring arg1, jint arg2) {
    if (sJavaVM == nullptr) {
        LOGE(TAG, "sJavaVM is nullptr");
        return;
    }
...
int JniHelper::callIntMethod(jobject obj, jmethodID methodId, jobject arg1) {
    if (sJavaVM == nullptr) {
        LOGE(TAG, "sJavaVM is nullptr");
        return -1;
    }
    ...
    int ret = -1;
    if (env != nullptr) {
        ret = env->CallIntMethod(obj, methodId, arg1);
    }
...
int JniHelper::callIntMethod(jobject obj, jmethodID methodId, jobject arg1, jobject arg2) {
    if (sJavaVM == nullptr) {
        LOGE(TAG, "sJavaVM is nullptr");
        return -1;
    }
...
int JniHelper::callIntMethod(jobject obj, jmethodID methodId) {
    if (sJavaVM == nullptr) {
        LOGE(TAG, "sJavaVM is nullptr");
        return -1;
    }
    ...
    int ret = -1;
    if (env != nullptr) {
        ret = env->CallIntMethod(obj, methodId);
    }
...
void JniHelper::callStaticVoidMethod(jclass cls, jmethodID methodId, jlong arg1, jint arg2, jint arg3, jint arg4,
    ...
    if (env != nullptr) {
        env->CallStaticVoidMethod(cls, methodId, arg1, arg2, arg3, arg4, arg5, arg6);
    }
...
void JniHelper::callStaticVoidMethod(jclass cls, jmethodID methodId, jstring arg1, jint arg2, jint arg3, jint arg4, jbyteArray arg5) {
    ...
    if (env != nullptr) {
        env->CallStaticVoidMethod(cls, methodId, arg1, arg2, arg3, arg4, arg5);
    }
...
void JniHelper::callStaticVoidMethod(jclass cls, jmethodID methodId, jstring arg1, jstring arg2) {
    ...
    if (env != nullptr) {
        env->CallStaticVoidMethod(cls, methodId, arg1, arg2);
    }
...
void JniHelper::callStaticVoidMethod(jclass cls, jmethodID methodId, jstring arg1, jstring arg2, jstring arg3) {
    ...
    if (env != nullptr) {
        env->CallStaticVoidMethod(cls, methodId, arg1, arg2, arg3);
    }
...
void JniHelper::callStaticVoidMethod(jclass cls, jmethodID methodId, jint arg1, jint arg2, jint arg3, jbyteArray arg4) {
    ...
    if (env != nullptr) {
        env->CallStaticVoidMethod(cls, methodId, arg1, arg2, arg3, arg4);
    }
